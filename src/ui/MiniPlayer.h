...
public:
    explicit MiniPlayer(AudioPlayer *player,
...
private:
    ...
    QStackedWidget *m_thumbStack;   // index 0 = audio label, 1 = video widget
    QLabel         *m_audioArt;     // hiện khi phát audio
    VideoThumbnail *m_videoThumb;   // hiện khi phát video — crop center, bo góc
